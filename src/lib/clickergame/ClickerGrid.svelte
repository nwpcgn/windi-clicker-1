...
<section class="page-grid">
	<aside class="aside">
		<div class="h-12 w-12" />
		<section
			class="absolute bg-gray-900 divide-blue-500 divide-x flex inset-0 text-blue-500 z-10 md:divide-x-0 md:divide-y md:flex-col">
			<slot name="menu">
	...
	<article class="article">
		<slot>
			<section class="layer">
				<div class="p-4">
					<div
						class="p-4 border rounded bg-white bg-opacity-70 w-full h-40 flex items-center justify-center"
						data-pg-class-style-inline="w-full h-40 flex items-center justify-center"
						data-pg-class-style="card">
						<a
							href="#_"
